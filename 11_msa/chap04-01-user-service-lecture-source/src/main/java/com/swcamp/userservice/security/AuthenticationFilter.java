...
import com.swcamp.userservice.dto.RequestLoginDTO;
...
//                               .map(role -> role.getAuthority())
        ...
        //@Value or environment으로 꺼내쓰면됨

        /* 설명. 2. 재료를 활용한 JWT 토큰 제작 (build.gradle에 라이브러리 추가)*/
