package com.swcamp.mybatisspring.config;

import com.swcamp.mybatisspring.section01.factorybean.MenuMapper;
...
//의존성 주입은 아니고 설정에서부터 값 가져오는 어노테이션, 키 값이 틀리지만 않으면 값을 제대로 가져옴
    ...
    public HikariDataSource dataSource() {
        ...
        dataSource.setIdleTimeout(600000); // 600초(10분)
        /* 설명. 데이터베이스 연결 최대 유지 시간*/
        dataSource.setMaxLifetime(1800000); // 1800초 (30분)
